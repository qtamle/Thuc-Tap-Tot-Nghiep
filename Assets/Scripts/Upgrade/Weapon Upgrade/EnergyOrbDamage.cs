...
public class EnergyOrbDamage : MonoBehaviour
{
    [Header("Damage")]
    ...
    private EnergyOrbsShootPool energyOrb;
    ...
    private void Start()
    {
        ...
        energyOrb = FindFirstObjectByType<EnergyOrbsShootPool>();
    }

    private void Update()
    {
        Collider2D[] enemies = Physics2D.OverlapCircleAll(transform.position, radiusDamage, damageLayer);
