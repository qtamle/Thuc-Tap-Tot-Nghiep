...
public class NetworkObjectPool : NetworkBehaviour
{
    ...
    /// <returns></returns>
    public NetworkObject GetNetworkObject(GameObject prefab, Vector2 position)
    {
...
class PooledPrefabInstanceHandler : INetworkPrefabInstanceHandler
{
    ...
    {
        // Chuyển đổi từ Vector3 sang Vector2 nếu cần
        Vector2 position2D = new Vector2(position.x, position.y);
        return m_Pool.GetNetworkObject(m_Prefab, position2D);
    }
